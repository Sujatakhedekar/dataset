...
/*
Consider university of mumbai as the base class allocating array of roll numbers to two colleges
mldc and sathaye(methods in class).
Where enrollment will happen and hence create a smart contract to place the first ten roll numbers
in mldc contract and last ten roll numbers in sathaye contract, also find the factorial of first four numbers in
each contract.
*/
